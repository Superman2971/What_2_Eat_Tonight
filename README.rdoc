= What 2 Eat Tonight
==================
<b>The visual decision for the craving you can't describe</b>
...
<em>Other notes: during the development process I integrated the Yelp API (but images are maximum of 100x100 pixels), then the Google Places API (but only 1 image per location provided, which was generally the store front and not the food), and a web scraper was developed to pull data from Yelp which worked but Yelp's AJAX limited information pulls to the first page of search results</em>
